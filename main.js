...
const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbyYZzz-FiNew9MG2VeplccQDn_PEerFLkMxntFVlsJKcTK3sGPl8rimrhf98V1yyKxy5Q/exec";
...
function editProducto(id) {
  ...
  document.getElementById("p_codigo").value = producto.código;
  document.getElementById("p_categoria").value = producto.categoría;
  document.getElementById("p_precio_compra").value = producto.precio_compra;
  document.getElementById("p_precio_venta").value = producto.precio_venta;
